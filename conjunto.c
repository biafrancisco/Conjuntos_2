...
// Aloca memoria para um conjunto, define seu tamanho para 0 e aloca memoria para 1 elemento e retorna o endereco desse conjunto
...
struct conjunto *uniao(struct conjunto *c1, struct conjunto *c2) {
	...
	// Insere no conjunto uniao, de forma ordenada, os elementos do conjunto c2 que ainda nao pertencem ao conjunto c1
